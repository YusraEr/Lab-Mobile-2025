...
public class FormActivity extends AppCompatActivity {
    ...
    private void saveStudent() {
        ...
        if (isEdit) {
            values.put(DatabaseContract.StudentColumns.UPDATED_AT, getCurrentDateTime());
            ...
            values.put(DatabaseContract.StudentColumns.UPDATED_AT, "");
            values.put(DatabaseContract.StudentColumns.CREATED_AT, getCurrentDateTime());
